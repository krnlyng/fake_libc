...
//DISPATCH_GLIBC(__errno);
//DISPATCH_GLIBC(__exit);
...
//DISPATCH_GLIBC(__gnu_basename);
//DISPATCH_GLIBC(__gnu_ldivmod_helper);
DISPATCH_GLIBC2(__gnu_strerror_r, strerror_r);
...
//DISPATCH_GLIBC(clock_getcpuclockid);
//DISPATCH_GLIBC(clock_getres);
//DISPATCH_GLIBC(clock_gettime);
//DISPATCH_GLIBC(clock_nanosleep);
//DISPATCH_GLIBC(clock_settime);
...
//DISPATCH_GLIBC(pthread_detach);
//DISPATCH_GLIBC(pthread_equal);
//DISPATCH_GLIBC(pthread_exit);
//DISPATCH_GLIBC(pthread_getattr_np);
//DISPATCH_GLIBC(pthread_getcpuclockid);
//DISPATCH_GLIBC(pthread_getschedparam);
//DISPATCH_GLIBC(pthread_getspecific);
//DISPATCH_GLIBC(pthread_gettid_np);
//DISPATCH_GLIBC(pthread_join);
//DISPATCH_GLIBC(pthread_key_create);
//DISPATCH_GLIBC(pthread_key_delete);
//DISPATCH_GLIBC(pthread_kill);
...
//DISPATCH_GLIBC(pthread_mutexattr_destroy);
//DISPATCH_GLIBC(pthread_mutexattr_getpshared);
//DISPATCH_GLIBC(pthread_mutexattr_gettype);
//DISPATCH_GLIBC(pthread_mutexattr_init);
//DISPATCH_GLIBC(pthread_mutexattr_setpshared);
//DISPATCH_GLIBC(pthread_mutexattr_settype);
//DISPATCH_GLIBC(pthread_once);
...
//DISPATCH_GLIBC(pthread_setspecific);
...
//DISPATCH_GLIBC(select);
//DISPATCH_GLIBC(sem_close);
//DISPATCH_GLIBC(sem_destroy);
//DISPATCH_GLIBC(sem_getvalue);
//DISPATCH_GLIBC(sem_init);
//DISPATCH_GLIBC(sem_open);
//DISPATCH_GLIBC(sem_post);
//DISPATCH_GLIBC(sem_timedwait);
//DISPATCH_GLIBC(sem_trywait);
//DISPATCH_GLIBC(sem_unlink);
//DISPATCH_GLIBC(sem_wait);
//DISPATCH_GLIBC(send);
...
//DISPATCH_GLIBC(timer_create);
//DISPATCH_GLIBC(timer_delete);
//DISPATCH_GLIBC(timer_getoverrun);
//DISPATCH_GLIBC(timer_gettime);
//DISPATCH_GLIBC(timer_settime);
